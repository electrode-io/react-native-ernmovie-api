public class Director: ElectrodeObject, Bridgeable {
    ...
    required public init(dictionary:[AnyHashable:Any]) {
        ...
        if let name = dictionary["name"] as? String  {
            ...
            assertionFailure("\(Director.tag) missing one or more required properties [name] ")
        ...
        if let gender = dictionary["gender"] as? String  {
            ...
            assertionFailure("\(Director.tag) missing one or more required properties [gender] ")
